...
| 5 | Real chatter on each record: messages, internal notes, tracked changes, @mentions, activities, followers | Linked internal messages and existing task activities in progress | Add tracked changes, mentions, followers, activity assignment, and remaining record types; keep outbound delivery opt-in |
