...
| 2 | Consistent record anatomy: breadcrumb/header, smart buttons, chatter, grouped record information, final Notes section | Customer, site, and equipment pages now use fewer related-work tabs with final Notes; supporting record layout still varies | Preserve every related record and create path while extending the anatomy to supporting records |
...
| 5 | Real chatter on each record: messages, internal notes, tracked changes, @mentions, activities, followers | Linked internal messages, tasks, and database-generated change entries | Add mentions, followers, activity assignment, and remaining record types; keep outbound delivery opt-in |
