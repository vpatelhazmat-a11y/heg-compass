  ...
  return (
    <>
      <PageHeader
        ...
        description="People, invitations, roles and a record of changes."
      />
      <div className="space-y-6 p-6">
        <Panel
          title="Invite a user"
          description="Send a secure Supabase invitation and assign the user's starting role."
        >
          <form
          ...
          >
            ...
            {invite.isSuccess && (
              <p className="md:col-span-2 xl:col-span-4 text-sm text-muted-foreground">
