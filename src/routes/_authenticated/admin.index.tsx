...
export const Route = createFileRoute("/_authenticated/admin/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "People, invitations, roles and record activity in the Hub." },
    ],
  }),
  component: AdminPage,
});
        ...
        <Panel title="Invite a user" description="Send a secure Supabase invitation and assign the user's starting role.">
          ...
          >
            ...
            <div className="md:col-span-2 xl:col-span-4 flex items-center justify-between gap-4">
              <p className="text-sm text-muted-foreground">Invitations expire after 7 days. The user can finish account setup from the invitation email.</p>
        ...
        <Panel title="Pending invitations" description="Recent invitations sent by administrators.">
          <DataTable
            columns={[
              ...
              { key: "role", header: "Role", render: (row) => ROLE_LABELS[row.role as AppRole] ?? row.role },
