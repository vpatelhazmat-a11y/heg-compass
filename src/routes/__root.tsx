...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { title: "HEG Commercial Intelligence Hub" },
      {
        name: "description",
        content:
          "Internal commercial and operational intelligence platform for HazMat Environmental Group Inc.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "/compass.svg", type: "image/svg+xml" },
    ],
  }),
