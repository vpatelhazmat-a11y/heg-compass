...
export const customerFields: FieldConfig[] = [
  ...
  { name: "industry", label: "Industry", section: "Basic information" },
  {
    ...
    label: "Status",
    type: "select",
    options: OPTIONS.customerStatus,
...
export const equipmentFields: FieldConfig[] = [
  { name: "unit_number", label: "Unit number", required: true, section: "Identity" },
  {
    ...
    label: "Category",
    type: "select",
    options: OPTIONS.equipmentCategory,
    section: "Identity",
  },
  { name: "equipment_type", label: "Type", section: "Identity" },
  {
    ...
    label: "Status",
    type: "select",
    options: OPTIONS.equipmentStatus,
    section: "Identity",
  },
  {
    name: "ownership_type",
...
export const incidentFields: FieldConfig[] = [
  ...
  },
  {
    ...
    label: "Status",
    type: "select",
    options: OPTIONS.incidentStatus,
    section: "What happened",
  },
  {
    name: "description",
...
export const contractFields: FieldConfig[] = [
  ...
  {
    name: "commercial_terms_summary",
    label: "Commercial terms summary",
    type: "textarea",
    section: "Terms",
  },
  { name: "notes", label: "Notes", type: "textarea", section: "Notes" },
...
export const assessmentFields: FieldConfig[] = [
  ...
  { name: "assessor", label: "Assessed by", section: "Basic information" },
  {
    ...
    label: "Status",
    type: "select",
    options: OPTIONS.assessmentStatus,
    section: "Basic information",
  },
  {
...
export const requirementFields: FieldConfig[] = [
  { name: "requirement", label: "Requirement", required: true, section: "Basic information" },
  {
    ...
    label: "Category",
    type: "select",
    options: OPTIONS.requirementCategory,
    section: "Basic information",
  },
...
export const lostBusinessFields: FieldConfig[] = [
  ...
  {
    name: "capacity_issue",
    label: "Capacity was a factor",
    type: "checkbox",
    section: "Contributing factors",
  },
  {
    name: "driver_issue",
    label: "Driver availability was a factor",
    type: "checkbox",
    section: "Contributing factors",
  },
  {
    name: "equipment_issue",
    label: "Equipment was a factor",
    type: "checkbox",
    section: "Contributing factors",
  },
  {
    name: "rate_issue",
    label: "Rate was a factor",
    type: "checkbox",
    section: "Contributing factors",
  },
  {
    name: "qualification_issue",
    label: "Qualification was a factor",
    type: "checkbox",
    section: "Contributing factors",
  },
  {
    name: "service_issue",
    label: "Service was a factor",
    type: "checkbox",
    section: "Contributing factors",
  },
...
export const equipmentAssignmentFields: FieldConfig[] = [
  {
    ...
    type: "select",
    options: OPTIONS.assignmentType,
    section: "Assignment",
  },
...
export const equipmentTechnologyFields: FieldConfig[] = [
  {
    ...
    label: "Technology",
    type: "select",
    options: OPTIONS.technologyType,
    section: "Device",
  },
