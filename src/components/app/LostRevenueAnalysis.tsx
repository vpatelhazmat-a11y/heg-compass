...
import { Bars, groupCount } from "./RefusedLoadSummary";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { listRows, type Row } from "@/lib/data";
import { formatMoney, formatNumber } from "@/lib/format";

export function LostRevenueAnalysis() {
  ...
  if (rows.isError || customers.isError)
    return (
      <ErrorState
  ...
  if (rows.isPending || customers.isPending) return <LoadingState />;
  return (
    <>
      <h2 className="px-6 pt-6 text-xl font-semibold">Lost revenue analysis</h2>
