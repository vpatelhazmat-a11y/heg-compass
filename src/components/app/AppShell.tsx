...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/lost-loads", label: "Refused Loads", icon: CircleOff },
    ],
  },
  {
    label: "Operations",
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-52">
                  ...
                  <DropdownMenuItem
                    ...
                    onSelect={() => setQuickCreate("customer")}
                  >
                    Customer
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    disabled={!canEdit("opportunities")}
                    onSelect={() => setQuickCreate("opportunity")}
                  >
                    Opportunity
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    disabled={!canEdit("bids")}
                    onSelect={() => setQuickCreate("bid")}
                  >
                    Bid
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    disabled={!canEdit("equipment")}
                    onSelect={() => setQuickCreate("equipment")}
                  >
                    Equipment
                  </DropdownMenuItem>
                  <DropdownMenuItem
                  ...
                  <DropdownMenuItem
                    disabled={!canEdit("documents")}
                    onSelect={() => setQuickCreate("document")}
                  >
                    Document
                  </DropdownMenuItem>
                </DropdownMenuContent>
